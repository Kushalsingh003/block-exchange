...
export default function OtpLogin() {
  const emailOtpInputRef = useRef();
  const googleOtpInputRef = useRef();
  ...
  async function emailLoginOtpVerify(data) {
    try {
      const res = await axios.post("/api/login/loginFaOtp", data);
      const response = res.data;
      console.log(response, "to get response from api to login");
  ...
  async function formSubmitHandler(event) {
   ...
   const otp = googleOtpInputRef.current.value;
   const otpEmail = emailOtpInputRef.current.value;
            ...
            <form className="input-sec ">
              ...
              <div className="tab-content" id="myTabContent">
                ...
                >
                  ...
                  <div className="input-item">
                    <h6 className="item-text">Google Authenticator Verification Code</h6>
                    <div className="input-group mb-3">
                      <input
                        ref={googleOtpInputRef}
                        type="text"
                        className="form-control"
                        placeholder="Enter Verification Code"
                        // aria-label="Recipient's username"
